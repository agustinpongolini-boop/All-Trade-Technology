          ...
          <div className="relative p-7 md:p-10 grid md:grid-cols-[1fr_auto] gap-10 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-5">
                <a
                  href={CONSULTATION.calendarUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="glass-btn-primary group inline-flex items-center justify-center gap-2.5 font-heading text-[12px] font-semibold uppercase tracking-wider px-7 py-3.5 rounded-xl"
                >
            ...
            {/* Right: glass slot tile (decorative calendar slot, no avatar) */}
